...
# COCO_FEATURES = torch.load('/mnt/dolphinfs/ssd_pool/docker/user/hadoop-nlp-sh02/3A/multimodal/3A/lihongyu23/projects/t2i_cot/ckpt/eval_ckpt/expert_weights/coco_features.pt')['features']
# ADE_FEATURES = torch.load('/mnt/dolphinfs/ssd_pool/docker/user/hadoop-nlp-sh02/3A/multimodal/3A/lihongyu23/projects/t2i_cot/ckpt/eval_ckpt/expert_weights/ade_features.pt')['features']
# DETECTION_FEATURES = torch.load('/mnt/dolphinfs/ssd_pool/docker/user/hadoop-nlp-sh02/3A/multimodal/3A/lihongyu23/projects/t2i_cot/ckpt/eval_ckpt/expert_weights/detection_features.pt')['features']
# BACKGROUND_FEATURES = torch.load('/mnt/dolphinfs/ssd_pool/docker/user/hadoop-nlp-sh02/3A/multimodal/3A/lihongyu23/projects/t2i_cot/ckpt/eval_ckpt/expert_weights/background_features.pt')
