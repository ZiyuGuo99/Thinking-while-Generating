...
model, preprocess = clip.load("/mnt/dolphinfs/ssd_pool/docker/user/hadoop-nlp-sh02/3A/multimodal/3A/lihongyu23/projects/t2i_cot/ckpt/eval_ckpt/ViT-B-32.pt", device=device)
